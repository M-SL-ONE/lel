...
function getCk(){
	...
	str = encodeURI(str);
	str2 = encodeURI(str2);
	var url = port+'/buy.ashx?oper=1&mobile='+mobile+'&user='+user+'&pass='+pass+'&cmd=table';
	// alert(url)
...
function all(){
	...
	ajax('POST',port+'/buy.ashx?oper=1&mobile='+mobile+'&user='+user+'&pass='+pass+'&cmd=table',JSON.stringify({                    
        'comsql':str,
		'headsql':goods,
		'detailsql':''
    }),
...
function GetInfo(item_no){
	...
	var url = port+'/buy.ashx?oper=1&mobile='+mobile+'&user='+pass+'&pass='+pass+'&cmd=table';
	$.ajax({
        url : url,
        type : "post",
        data : JSON.stringify({    
